...
def show_notification(message):
    ...
    # Check if the icon file exists
     if not os.path.exists(icon_path):
        # If the file doesn't exist, you might want to provide a default icon or handle the error accordingly
...
def display_current_settings_values():
    ...
    # Add your program information widgets to the 'about_tab' frame
